...
//       tooltip: 'Increment',
//       backgroundColor: Color.fromRGBO(60, 60, 60, 70),
//       child: Icon(Icons.add),
//     );

//     return Scaffold(
//       backgroundColor: Color.fromRGBO(41, 41, 41, 100),
//       // floatingActionButton: Align(alignment: Alignment(1, 0.7)),
//       appBar: AppBar(
//         // Here we take the value from the MyHomePage object that was created by
//         // the App.build method, and use it to set our appbar title.
//         title: Text(widget.title),
//         backgroundColor: Color.fromRGBO(41, 41, 41, 30),
//       ),
//       body: Center(
...
//           children: <Widget>[
//             Text(
//               'App ko dark mode mein design karte hai',
